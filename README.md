...
💻 **Actuellement:** Développement d’un projet e-commerce full-stack avec **Laravel & Vue.js**  
🌱 **Apprentissage:** Laravel, Vue.js, et comment survivre sans pizza 🍕😅  
👯 **Collaboration:** Projets open-source web  
🤝 **Aide recherchée:** Stopper mon code de planter quand je cligne des yeux 👀💥  
...
| Projet | Stack | Lien |
|--------|-------|------|
| E-commerce Fullstack | Laravel + Vue.js + MySQL | [Voir Repo](https://github.com/abirmeskin22-glitch/laravel-ecommerce) |
| Gestion de tâches | React + Node.js + MongoDB | [Voir Repo](https://github.com/abirmeskin22-glitch/task-manager) |
| Portfolio | HTML + CSS + JS | [Voir Site](https://abirmeskin.dev) |
